  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/GuyFarley/portfolio.git" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{ height: '100%' }}>
          <div className="col-md-12">
            <div>
              <img src="./images/fall_river_1400_422.JPG" alt="Guy Farley fly fishing on the Fall River" />
